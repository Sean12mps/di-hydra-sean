...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					sprintf(
						...
						esc_html__( 'Proudly powered by %s', 'hydra' ),
						'<a href="' . esc_url( __( 'https://www.dinkuminteractive.com/', 'hydra' ) ) . '" rel="nofollow">Dinkum Interactive</a>'
					) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
